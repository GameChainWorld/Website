...
$(function(){
    ...
    var cn = {
        ...
        invitation_page_codetip : '在获取资格页面输入邀请码，可获得参与GameChain社区的资格',
    ...
    var en = {
        ...
        share_tips_pc  : 'Share tips: right-click, save as image and share',
        press_code_tip_pc  : 'Use a mobile phone to scan the QR code for details',
    ...
    var ja = {
        ...
        invitation_page_codetip : '資格獲得のページで招待コードを入力して、GameChain',
     ...
     * 画图
     */
    // var qrCodeText = "../whitelist/index.html?code="; 
