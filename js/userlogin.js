$(function(){
    ...
    var language = {
        cn: {
            ...
            account_tip1: "还没有GameChain账号？",
            account_tip2: "已有GameChain账号？",
        ...
        en: {
            ...
            account_tip1: "No GameChain account yet?",
            account_tip2: "Already have a GameChain account?",
            ...
            redister_fail : 'Registration failed, account or nickname already exists!',
            register_success : 'Account registration successful!',
            login_fail : 'Login failed with incorrect account or password!',
            login_success : 'Login successful!',
            send_fail : 'Failed to send mail!',
            send_success : 'Mail sent successfully!',

            result_button : 'OK',
            again_login_btn : 'Log in Again',
            again_register_btn : 'Register Again',
            ...
            registerFail_text2 : "Registration failed! Incomplete information! ",
            registerFail_text3 : "Registration failed! Unavailable email box!",
            registerFail_text4 : "Registration failed! Email box has been registered!",
            registerFail_text5 : "Registration failed! Existed nickname!",
            registerFail_text6 : "Registration failed! Nonexistent invitation code!",
            registerFail_text7 : "Registration failed! Invalid invitation code!",
            registerFail_text8 : "Registration failed! Expired invitation code!",
            registerFail_text9 : "Registration failed! Unavailable invitation code!" ,

            loadMyDataFail_text : "Failed to load personal data . Please refresh the page and try again!",
            personInfo_text : "Personal information",
            basicInfo_text : "Basic information" ,
            basicInfo_text1 : "Your account" ,
            basicInfo_text2 : "Wallet address" ,
            basicInfo_text3 : "Nickname" ,
            promotionInfo_text : "Promotion information",
            promotionInfo_text1 : "Your invitation code quantity",
            promotionInfo_text2 : "Click the button below to generate your unique invitation code that can be sent to the friend you are inviting.",
            promotionInfo_text3 : "Generate invitation code ",
            getMyCodeFail_text : "Failed to generate invitation code! Please refresh the page and try again!",
            getMyCodeFail_text1 : "Failed to generate invitation code! The number of invitations has reached the upper limit.",
            getMyCodeFail_text2 : "Failed to generate invitation code! The invitation period has passed.",  
        }
    }
   ...
   var clickEvent = function(){
         $(".lay_button").unbind("click").click(function(){
            ...
            // var loginurl = "http://game.fund:8443/whitelist/general/login";
        ...
        $(".lay_send").unbind("click").click(function(){
            ...
            if(!checkPwd()) return;
            var form = new FormData(document.getElementById("form_common_id"));
            // var regurl = "http://game.fund:8443/whitelist/general/nocoderegister";
        ...
        $(".lay_submit").unbind("click").click(function(){
            ...
            var form = new FormData(document.getElementById("form_common_id"));
            // var regurl = "http://game.fund:8443/whitelist/general/forgetPsw";
    ...
    function get_invitationCode(userInfo){
        ...
        function getInvitation_callback(result){
            if(result.status == 0){
                ...
                addScript("https://game.fund/js/invitation_card.js");//生成邀请函图片
            }else{
                console.log("生成邀请码失败！")
                $(".container-outer form .form-content").empty();
                $(".container-outer form .form-content").append(
