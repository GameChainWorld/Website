...
$(function(){
    ...
    function translation(){
        ...
        if(language == "cn"){
            ...
            $("#news_content_item5").html("GameChain 创始人董浩，3月16日将在NEO meetup韩国首尔站，进行项目首次路演。欢迎加入我们！");
            $("#news_content_item6").html("GameChain 创始人董浩，3月16日将在NEO meetup韩国首尔站，进行项目首次路演。欢迎加入我们！");
            ...
            $("#news_content_item4").html("2018-03-15-BY GameChain TEAM");
            $("#news_content_item5").html("DONG Hao, Founder of GameChain presenting at Seoul NEO Meetup on Friday, Mar 16. Come and join us! Emerald Hall B, Grand Hilton Seoul, Mar 16, 18:00–21:40(KST)");
            $("#news_content_item6").html("DONG Hao, Founder of GameChain presenting at Seoul NEO Meetup on Friday, Mar 16. Come and join us! Emerald Hall B, Grand Hilton Seoul, Mar 16, 18:00–21:40(KST)");
